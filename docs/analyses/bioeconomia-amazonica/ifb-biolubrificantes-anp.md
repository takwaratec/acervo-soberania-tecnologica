...
| Campo | Dado |
|-------|------|
| **Título** | Biolubrificantes — ANP (2020) |
| **Autor(es)** | MATOS |
| **Ano** | 2020 |
| **Páginas** | 6 p. |
| **Eixo temático** | Geral |
...
Documento técnico-científico sobre biolubrificantes — anp (2020). MATOS, P. R. R. **Biolubrificantes**. Acervo Digital Mulheres que Tecem a Floresta, Consórcio UnB/UFAC/UFRR, 2020. 6 p....

## 3. Problema e Perguntas de Pesquisa
**Tema central:** Biolubrificantes — ANP (2020). O documento investiga matos, p.
...
MATOS, P. R. R. **Biolubrificantes**. Acervo Digital Mulheres que Tecem a Floresta, Consórcio UnB/UFAC/UFRR, 2020. 6 p.
