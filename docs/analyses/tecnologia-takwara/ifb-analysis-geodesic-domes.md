...
# IFB — Analysis of Geodesic Domes (2021)
...
O documento apresenta-se como artigo científico. artigo científico. This paper presents an analysis of geodesic dome structures, including their structural behavior, design considerations, and comparative performance under various loading conditions....

## 3. Problema e Perguntas de Pesquisa
**Tema central:** Analysis of Geodesic Dome Structures: Design and Structural Behavior. 
...
## 7. Avaliação Crítica
**Contribuições:** Documento que contribui com dados sobre conceitos e fundamentos relacionados a geodésicas.
...
## Referência (ABNT)
Kolpakov, A.; Dolgov, O.. **Analysis of Geodesic Dome Structures: Design and Structural Behavior**. 2021.
