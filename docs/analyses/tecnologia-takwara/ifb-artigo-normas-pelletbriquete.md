...
| Campo | Dado |
|-------|------|
| **Título** | Artigo Normas Pellet/Briquete (2018) |
| **Autor(es)** | AUTOR |
| **Ano** | 2018 |
| **Páginas** | 20 p. |
| **Eixo temático** | Geral |
...
Documento técnico-científico sobre artigo normas pellet/briquete (2018). AUTOR(ES). **Artigo normas pellet/briquete**: padronização e mercado. 2018. 20 p....

## 3. Problema e Perguntas de Pesquisa
**Tema central:** Artigo Normas Pellet/Briquete (2018). O documento investiga autor(es).
...
AUTOR(ES). **Artigo normas pellet/briquete**: padronização e mercado. 2018. 20 p.
