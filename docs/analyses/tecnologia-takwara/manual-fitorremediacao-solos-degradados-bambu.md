...
numero: 2
titulo: Fitorremediação e Mercados de Carbono — O Bambu como Engenheiro Ecológico (Do Solo Contaminado ao Crédito Certificado)
autor: Fabio Takwara
...
acesso: publico
licenca: CC-BY-4.0
metodo: fitorremediacao-biochar-e-certificacao-de-carbono
...
## Do Solo Contaminado ao Crédito Certificado
...
[![English Version](https://img.shields.io/badge/Language-English_v2.2-blue.svg)](manual-fitorremediacao-solos-degradados-bambu-en.md)
...
**Fitoextração (fitoacumulação):** a planta absorve os metais pelas raízes e os transloca para as partes aéreas (colmos, folhas). A biomassa aérea contaminada é então colhida e removida, "limpando" progressivamente o solo ao longo de vários ciclos de cultivo.

**Fitoestabilização:** a planta imobiliza os contaminantes no solo, reduzindo sua mobilidade e biodisponibilidade. Ela absorve e sequestra metais nas raízes, adsorve na superfície radicular e precipita na rizosfera. Isso impede a lixiviação para águas subterrâneas e a entrada na cadeia alimentar.
...
O padrão consistente observado em diversas espécies de bambu — incluindo *Guadua angustifolia* e *Phyllostachys edulis* — é um **FBC radicular > 1** (o bambu acumula ativamente o metal, concentrando-o nas raízes acima do nível do solo) e um **FT < 1** (o bambu *impede ativamente* que esse metal chegue aos colmos e folhas).
...
| *Phyllostachys praecox* | Pb | Raiz | Alto | < 1 | Acumulação de chumbo: até 26.388 mg/kg nas raízes |
| *Pleioblastus fortunei* | Pb | Folha | 2,48 | 1,31 | Potencial de fitoextração de chumbo |

> ⚠️ **Salvaguarda Ecológica do Acervo:** *Phyllostachys* spp. são eficazes na fitorremediação, mas **não devem ser plantadas em novas áreas** em função do seu comportamento exótico invasor. Use-as apenas onde já existem — o manejo e a colheita da biomassa já instalada é uma forma de fitoextração e contenção. Para plantio novo em áreas degradadas, use exclusivamente **espécies nativas**, especialmente *Guadua* spp.

---

## SEÇÃO 2 — ESPÉCIES CORRETAS PARA RESTAURAÇÃO ECOLÓGICA

### 2.1 O Caso da Guadua: O Maior Estoque Edáfico de Carbono

O *Guadua angustifolia* é a espécie de bambu com o maior estoque total de carbono registrado na literatura científica: **672,3 tC/ha** em um ecossistema completo. O dado mais surpreendente é que **78% desse carbono está no solo** — em raízes, rizomas e matéria orgânica acumulada.

---

## SEÇÃO 4 — CRÉDITOS DE CARBONO E BIOCHAR

### 4.2 Biochar: O Carbono que Fica para Sempre

A pirólise (aquecimento de biomassa sem oxigênio a 350–600 °C) transforma o carbono orgânico lábil da biomassa em carbono recalcitrante, resistente à decomposição microbiana por centenas de anos:

$$
C_{sequestrado} = m_{biochar} \times w_C \times (1 - R_{decomp,100a}) \times \frac{44}{12}
$$

A metodologia de certificação de referência global para créditos de biochar é a **VERRA VM0044** (*Methodology for Biochar Utilization in Soil and Non-Soil Applications*).

---

## SEÇÃO 8 — O BROTO DE BAMBU COMO ALIMENTO: DESMISTIFICANDO A TAXIFILINA

### 8.2 Protocolo de Desintoxicação

| Método | Condições | Redução de HCN | Observação |
| :-- | :-- | :-- | :-- |
| **Fervura** | Fatiado, 20 min em água | > 87% | Método universal; trocar a água aumenta a eficácia |
...
## REFERÊNCIAS DA COLEÇÃO DA SÉRIE

- TAKWARA, Fabio. *Biochar de biomassa e uso em cascata do bambu: solo, carbono, energia e coprodutos*. Cadernos de Revisão Ecológica e Soberania Tecnológica, n. 6, 2026. DOI: [10.5281/zenodo.21515443](https://doi.org/10.5281/zenodo.21515443).
- TAKWARA, Fabio. *O ciclo que não termina no descarte: bambu, mamona e responsabilidade diante da crise planetária*. Cadernos de Revisão Ecológica e Soberania Tecnológica, n. 7, 2026. DOI: [10.5281/zenodo.21515567](https://doi.org/10.5281/zenodo.21515567).
- TAKWARA, Fabio. *Matriz de viabilidade econômica e continuidade territorial*. Cadernos de Revisão Ecológica e Soberania Tecnológica, Anexo 1, 2026. DOI: [10.5281/zenodo.21515657](https://doi.org/10.5281/zenodo.21515657).

---
*Manual integrante da Série Técnica Tecnologia Takwara. Licença CC BY 4.0.*
