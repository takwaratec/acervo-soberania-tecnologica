...
> Base: TAK_manual-fitorremediacao-credito-carbono.md (v2.1, dist_zenodo_v2.2.2,
> texto integral — decisão D1: PT integral). DOI novo será atribuído após reserva
> da nova versão. Changelog e declaração de limites nas seções finais.
...
$$
FBC = \frac{[\text{Metal}]_{\text{planta}}}{[\text{Metal}]_{\text{solo}}}
$$
...
## SEÇÃO 3 — TÉCNICAS DE RESTAURAÇÃO ECOLÓGICA (reportadas na literatura)
...
**MÉTODO 1 — RNA (Baixa Intervenção)**
*Quando usar:* áreas com bom banco de sementes no solo, próximas a fragmentos florestais, sem compactação severa.
*Ações:* instalação de cerca; controle de gramíneas invasoras; poleiros artificiais.
*Custo:* R\$ 800–1.500/ha
*Acúmulo de carbono:* lento nos primeiros 5 anos; sólido após 10 anos.

**MÉTODO 2 — Semeadura Direta (Muvuca) (Média Intervenção)**
*Quando usar:* áreas médias a grandes (> 5 ha), com algum solo exposto, onde o plantio de mudas seria inviável economicamente.
*Definição:* "Muvuca" é a mistura de alta diversidade de sementes nativas — pioneiras, secundárias e espécies clímax — semeadas em alta densidade, geralmente com adubação verde (feijão-de-porco, crotalária). O resultado é uma floresta mais densa, natural e de menor custo do que o plantio convencional.
*Custo:* R\$ 1.500–3.000/ha (vs. R\$ 8.000–15.000/ha no plantio convencional)
*Diferencial:* reportado na literatura de restauração ecológica como eficaz para semeadura direta de alta diversidade em áreas médias a grandes (ver referências da Seção de Restauração); não constitui declaração de eficácia geral da fitorremediação nem do Sistema Takwara.

**MÉTODO 3 — Plantio de Mudas (Alta Intervenção)**
*Quando usar:* áreas altamente degradadas, compactadas, sem banco de sementes e distantes de fragmentos florestais.
*Composição recomendada:* 40–50% pioneiras + 30–40% secundárias + 10–20% clímax. Para áreas com fitorremediação, incluir *Guadua* spp. nativa nas faixas ripárias e bordas.
...
- $w_C$ = fração mássica de carbono no biochar (0,72–0,85 para pirólise de bambu, conforme literatura)
...
**Certificação:** VERRA VM0044 (*Methodology for Biochar Utilization in Soil and Non-Soil Applications*). É a metodologia de referência global para créditos de biochar, com protocolo de monitoramento e verificação específico. Link direto: [verra.org/methodologies/vm0044](https://verra.org/methodologies/vm0044-methodology-for-biochar-utilization-in-soil-and-non-soil-applications/)
...
**Cadastro Ambiental Rural (CAR):** cadastro obrigatório de toda propriedade rural. É o ponto de entrada para regularização ambiental e, cada vez mais, para acesso a crédito rural e certificação. Link: [car.gov.br](https://www.car.gov.br)
...
- Para Mata Atlântica: adotar protocolos do **Pacto pela Restauração da Mata Atlântica** ([pactomataatlantica.org.br](https://www.pactomataatlantica.org.br))
...
| :-- | :-- | :-- | :-- |
| **Fundo Amazônia (BNDES)** | Projetos de restauração e uso sustentável na Amazônia Legal | Chamadas públicas periódicas; monitorar site BNDES | [fundoamazonia.gov.br](https://www.fundoamazonia.gov.br/pt/chamadas-publicas/) |
| **GCF — Green Climate Fund** | Adaptação e mitigação climática | Via Entidades Acreditadas (BNDES, Caixa Econômica) — parcerias com AEs nacionais | [greenclimate.fund](https://www.greenclimate.fund) |
| **TFFF — Tropical Forest Forever Facility** | Floresta em pé (USD 4/ha/ano); **20% obrigatório para povos indígenas e comunidades** | Via governos nacionais; posicionamento como executor local qualificado | [tropicalforestfund.org](https://www.tropicalforestfund.org) |
| **Floresta+** (MMA) | PSA para restauração e conservação em APPs e RLs | Plataforma gov.br | [floresta.mma.gov.br](https://floresta.mma.gov.br) |
| **FAPESP BIOTA** | Pesquisa aplicada em biodiversidade e restauração (SP) | Chamadas abertas FAPESP | [biota.org.br](http://www.biota.org.br) |
| **Pacto Mata Atlântica** | Restauração na Mata Atlântica; acesso a rede de parceiros | Adesão como signatário | [pactomataatlantica.org.br](https://www.pactomataatlantica.org.br) |
| **Fundo Canadá para Iniciativas Locais** | Projetos locais de pequeno porte (USD 5.000–50.000) | Via Embaixada do Canadá | [canadainternational.gc.ca](https://www.canadainternational.gc.ca/brazil-bresil) |

### 7.3 Fontes para o Tráfego — Receitas de Carbono Recorrentes

| Fonte | Metodologia | Valor estimado | Onde registrar |
| :-- | :-- | :-- | :-- |
| **Biochar (solo)** | VERRA VM0044 | USD 30–150/tCO₂e | [verra.org](https://verra.org) |
| **Restauração florestal** | Plan Vivo / VCS+CCB | USD 15–60/tCO₂e | [planvivo.org](https://planvivo.org) |
| **PSA hídrico** | Estadual (varia por estado) | R\$ 50–200/ha/ano | DAEE (SP); SEMAD (MG); SEMA (MT) |
| **REDD+ (Amazônia)** | VCS + CCB / Gold Standard | USD 5–30/tCO₂e | [verra.org](https://verra.org) |
| **Mercado voluntário nacional** | Em regulamentação (Lei 15.042/2024) | A definir | MCTI / B3 |

> ⚠️ **Atenção crítica:** A questão "quem pode vender o carbono?" está intrinsecamente ligada a "quem possui os direitos sobre a terra?" Em áreas de posse comunitária, sobreposição de títulos ou territórios tradicionais, a **auditoria fundiária é o Passo Zero** — antes de qualquer investimento. Realize a verificação da cadeia dominial no INCRA, nos registros de imóveis e integre dados do CAR com o SIGEF (Sistema de Gestão Fundiária: [sigef.incra.gov.br](https://sigef.incra.gov.br)).
...
> TORRES 2008, FERREIRA 1995 e FSANZ 2004 permanecem sem DOI localizado — mantidas por
> sustentarem afirmações da seção, com verificação pendente na etapa de fechamento.
> WANG 2023: o registro 10.3390/f14091895 (Forests 14(9):1895, 2023) coincide em
> volume/página, mas o título registrado difere do citado — DOI **não** atribuído como
> confirmação; verificação pendente.

**Fitorremediação e Ecologia do Bambu**

- BIAN, F. et al. Bamboo — an untapped plant resource for the phytoremediation of heavy metal contaminated soils. *Chemosphere*, v. 246, p. 125750, 2020. DOI: [10.1016/j.chemosphere.2019.125750](https://doi.org/10.1016/j.chemosphere.2019.125750)
- TORRES, F. G.; LIMA, V. L. A.; LIMA, R. M. Acúmulo e translocação de zinco e cádmio em plantas de bambu (*Guadua angustifolia*). *Química Nova*, v. 31, n. 1, p. 24–27, 2008. (DOI não localizado — verificação pendente)
- WANG, H. et al. Remediation of heavy metal contaminated soils by planting Moso bamboo and its intercropping with *Sedum plumbizincicola*. *Forests*, v. 14, n. 9, p. 1895, 2023. (DOI não confirmado — registro de volume/página diverge em título; verificação pendente)
- NEMENYI, A. et al. Potential use of bamboo in the phytoremediation of heavy metals: A review. *Acta Agraria Debreceniensis*, n. 1, p. 103–113, 2022. DOI: [10.34101/actaagrar/1/10311](https://doi.org/10.34101/actaagrar/1/10311)

**Carbono, Restauração e Certificação**

- Sociedade Internacional de Restauração Ecológica (SER). *Princípios da Restauração Ecológica*. Washington DC: SER, 2019. Disponível em: [ser.org](https://www.ser.org)
- Pacto pela Restauração da Mata Atlântica. *Protocolo de Monitoramento da Restauração Florestal*. São Paulo, 2023. Disponível em: [pactomataatlantica.org.br](https://www.pactomataatlantica.org.br)
- VERRA. *VM0044: Methodology for Biochar Utilization in Soil and Non-Soil Applications*. v. 1.2. Washington, DC, 2025. Disponível em: [verra.org](https://verra.org/methodologies/vm0044)
- Plan Vivo Foundation. *Plan Vivo Standard*. Edinburgh, 2024. Disponível em: [planvivo.org](https://www.planvivo.org)

**Marco Legal**

- BRASIL. *Lei nº 12.651/2012 — Código Florestal*: [planalto.gov.br](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2012/lei/l12651.htm)
- BRASIL. *Lei nº 14.119/2021 — Política Nacional de PSA*: [planalto.gov.br](https://www.planalto.gov.br/ccivil_03/_ato2021-2024/2021/lei/L14119.htm)
- OIT. *Convenção 169 — Povos Indígenas e Tribais*: [ilo.org](https://www.ilo.org/brasilia/convencoes/WCMS_236247/lang--pt/index.htm)
- BRASIL. *Lei 15.042/2024 — Mercado Regulado de Carbono (SBCE)*: [planalto.gov.br](https://www.planalto.gov.br)

**Segurança Alimentar — Brotos de Bambu**

- CHONGTHAM, N.; BISHT, M. S.; SARANGTHEM, K. Nutritional properties of bamboo shoots. *Comprehensive Reviews in Food Science and Food Safety*, v. 10, n. 3, p. 153–168, 2011. DOI: [10.1111/j.1541-4337.2011.00147.x](https://doi.org/10.1111/j.1541-4337.2011.00147.x)
- FOOD STANDARDS AUSTRALIA NEW ZEALAND (FSANZ). *Cyanogenic glycosides in cassava and bamboo shoots*. Canberra: FSANZ, 2004. (DOI não aplicável — relatório institucional; URL não localizada — verificação pendente)
- FERREIRA, V. L. P.; YOTSUYANAGI, K.; CARVALHO, C. R. L. Eliminação do teor de ácido cianídrico de brotos de bambu (*Bambusa vulgaris*). *Coletânea do ITAL*, v. 25, n. 2, p. 148–153, 1995. (DOI não localizado — verificação pendente)
...
## 9. CHANGELOG — VERSÃO CANDIDATA 2.2 (nova edição)
...
## 10. DECLARAÇÃO DE LIMITES (nova edição)

1. Os dados de eficácia de fitorremediação por espécie (Seção 1) e as técnicas de
   restauração (Seção 3) são **reportados da literatura referenciada**; não constituem
   resultados de ensaios próprios do Sistema Takwara.
2. Valores de custo por hectare (RNA, Muvuca, plantio de mudas) e de créditos de
   carbono são **estimativas/reportes setoriais** — a verificar na fase de projeto.
3. Menções a padrões de certificação (VERRA VM0044, Plan Vivo, Gold Standard) indicam
   metodologias vigentes citadas; a elegibilidade de um projeto específico depende de
   validação pelo padrão.
4. O protocolo de desintoxicação de brotos (Seção 8) é apresentado conforme a
   literatura (FSANZ, ITAL); eficácia individual deve ser confirmada por análise
   laboratorial.
5. Nenhuma declaração de TRL é feita neste documento.
6. O CLPI é tratado como requisito processual e legal; não substitui assessoria
   jurídica específica para cada território.
