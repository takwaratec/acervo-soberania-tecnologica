...
Documento técnico sobre projeto e construção de estruturas geodésicas em bambu, abordando princípios geométricos, tipos de domos, conexões estruturais e análise de cargas. PDF disponível no diretório `/Bibliografia Consultada/`.
