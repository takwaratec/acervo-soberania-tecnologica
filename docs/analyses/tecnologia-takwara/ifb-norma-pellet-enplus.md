...
| Campo | Dado |
|-------|------|
| **Título** | Norma Pellet ENPlus |
| **Autor(es)** | EUROPEAN PELLET COUNCIL |
| **Ano** | — |
| **Páginas** | 10 p. |
| **Eixo temático** | Geral |
| **Código** |  |
...
Documento técnico-científico sobre norma pellet enplus. EUROPEAN PELLET COUNCIL. **ENPlus: certification scheme for wood pellets**. Bruxelas: EPC, [s.d.]. 10 p....

## 3. Problema e Perguntas de Pesquisa
**Tema central:** Norma Pellet ENPlus. O documento investiga european pellet council.
