...
| Campo | Dado |
|-------|------|
| **Título** | Bamboo as Reinforcement in Structural Concrete Elements |
| **Autor(es)** | Khosrow Ghavami |
| **Ano** | 2003 |
...
O documento apresenta-se como artigo científico. artigo científico. This paper presents the results of an experimental investigation on the use of bamboo as reinforcement in structural concrete elements. Bamboo is a natural, cheap, and widely available material in tropical and subtropical regions....

## 3. Problema e Perguntas de Pesquisa
**Tema central:** Bamboo as Reinforcement in Structural Concrete Elements. 
...
## Referência (ABNT)
Khosrow Ghavami. **Bamboo as Reinforcement in Structural Concrete Elements**. Cement and Concrete Composites, v. 27, n. 6, p. 637-649, 2005. 2003.
