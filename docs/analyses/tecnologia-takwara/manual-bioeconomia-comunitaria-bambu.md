...
license: CC BY 4.0
related_works:
- https://doi.org/10.5281/zenodo.18827106
...
> Estado: em-revisao-documental · aguarda revisão humana antes de homologação.
> Base: TAK_manual-bioeconomia-bambu.md (v2.1, dist_zenodo_v2.2.2, texto integral —
> decisão D1: PT integral). DOI novo será atribuído após reserva da nova versão.
> Changelog e declaração de limites nas seções finais.

[![Licença: CC BY 4.0](https://img.shields.io/badge/Licenca-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/)
![Status](https://img.shields.io/badge/status-candidata%202.2-em%20revisão-orange)
![Idiomas](https://img.shields.io/badge/idiomas-PT%20(EN%20em%20rodada%20futura%2C%20D3)-blue)
...
> 🌱 **Histórias de quem já começou** — *relatos ilustrativos não verificados; nomes
> próprios preservados apenas para fins pedagógicos, sem valor de testemunho documental ou
> evidência validada:*
> - **Dona Conceição, Vinhedo (SP):** *relato ilustrativo* — herdou 2 ha de Phyllostachys aurea do marido. Passou 3 anos pagando R$ 800/ano para roçar. Hoje, com um grupo de 8 vizinhos, produz cabos de enxada e briquetes, e a "praga" virou renda extra de R$ 1.200/mês.
> - **Aldeia Tekoa Porã, Vale do Ribeira (SP):** *relato ilustrativo* — comunidade Guarani usava Bambusa vulgaris para artesanato há gerações. Com rastreabilidade e certificação de manejo ecológico, passou a acessar o programa PAA/CONAB e triplicou a renda com o bambu.
> - **Grupo Semear, Curitiba (PR):** *relato ilustrativo* — coletivo de mulheres que mapeou 47 propriedades com Phyllostachys aurea na região sul de Curitiba. Hoje negociam contrato piloto com a CEASA-PR para fornecimento de mudas de Dendrocalamus para arborização urbana e reflorestamento.
>
...
1. Abra o **Google Maps** no celular e vá até o local do bambu (pode ser sua própria casa ou propriedade)
2. Toque e segure o ponto no mapa por 2 segundos → aparece um marcador vermelho com coordenadas na parte de baixo da tela
3. Toque nas coordenadas → toque em **"Compartilhar"** → envie o link pelo WhatsApp
4. O link gerado tem o formato: `https://maps.google.com/?q=-23.123,-47.456`
...
1. Abra uma conversa no WhatsApp (o grupo da cooperativa ou o contato da Plataforma)
2. Toque no ícone de **clipe/anexo** → **Localização** → **Enviar localização atual**
3. **Importante: escolha "Localização fixa"** (não "Compartilhar localização em tempo real") — isso gera um ponto permanente no mapa, não uma transmissão ao vivo

---

**Via Google Earth — para estimar a área:**

1. Acesse [earth.google.com](https://earth.google.com) no celular ou computador
2. Pesquise seu endereço
3. Use a ferramenta **"Medir"** (régua) para traçar o perímetro da moita de bambu
4. O Google Earth calcula automaticamente a área em m² ou hectares

> 🗺️ Você também pode usar o **MapBiomas Alerta** ([alerta.mapbiomas.org](https://alerta.mapbiomas.org)) para verificar se a área já está mapeada por satélite como vegetação exótica — e adicionar o registro do bambu diretamente na plataforma.
...
> ⚠️ **Estimativas autorais:** todos os valores da escada acima são **projeções autorais
> a validar** (faixas de mercado citadas no original, sem fonte auditada). Não constituem
> tabela de preços, garantia de rentabilidade nem dado verificado — verificação na etapa
> de fechamento.

**O cabo de enxada é o "Cavalo de Troia" da cadeia:** ele custa R$ 15 para produzir (estimativa autoral), vende por R$ 35–50 (estimativa autoral) e é apresentado como produto de entrada que demonstra a tecnologia antes de investimentos maiores. **Alegações de desempenho (durabilidade de 5 anos contra 8 meses do cabo de madeira; suporte acima de 120 kg, o dobro do convencional) são especificações autorais sem ensaio publicado — desempenho a verificar em ensaios antes de qualquer uso comercial como argumento técnico.**
...
>
> **Nota de distinção tecnológica (correção material da nova edição):** a Junta Spin é tecnologia do LILD/PUC-Rio (Ripper). O **Sistema Takwara** descrito nos documentos da Plataforma é tecnologia distinta — baseada em ponteira semiflexível e cabo de aço interno pré-tensionado com sapatilhas, selado com PU Vegetal (ver Documento de Conexões Estruturais). Não se trata de réplica da Junta Spin, nem a Junta Spin é apresentada como invenção Takwara. **Critério de projeto proposto (hipótese, sem fonte técnica explícita):** a Junta Spin é apontada como adequada a estruturas de menor porte (frequências até V2); o Sistema Takwara seria indicado para frequências superiores (V3+). Este limite não está validado por fonte técnica/publicação e deve ser tratado como critério de projeto proposto ou limite ainda não determinado — não como fato validado — até ensaios comparativos.

---

### A Progressão das Frequências — do mais simples ao Domo Voador

Um domo geodésico baseado em icosaedro se torna mais esférico a cada "frequência" (V). Mais frequência = mais varas = maior diâmetro possível com varas menores. A progressão vai **do mais fácil para o mais espaçoso**, usando bambu com comprimentos práticos:

| Frequência | Perfil | Uso |
|:---|:---|:---|
| **V1** | Tenda autoportante, base pentagonal, ponto de partida (menor porte) | Tenda / 1ª casa / kit emergência |
| **V2** | Primeiro hemisfério verdadeiro, base circular e plana | Casa rural / estufa pequena |
| **V3 3/8** | Perfil abaixo do equador, equilíbrio entre vão e altura | Estufa / depósito / oficina |
| **V3 5/8** ★ | Perfil acima do equador, maximiza espaço interno e pé-direito central | **Domo Voador — HIS / abrigo emergencial** |
| **V4** | Grande vão, estruturas de maior escala | Grande vão / auditório / hangar |

> 🔒 **Parâmetros construtivos reservados:** as contagens de varas, tipos, conectores,
> coeficientes de truncagem e escalas de dimensionamento (incluindo tabelas derivadas de
> especificações técnicas de terceiros) são **reservados para avaliação de propriedade
> intelectual** e ficam fora desta versão pública. A geometria icosaédrica de frequências
> é de domínio público (tradição Fuller); a aplicação específica com bambu e o sistema de
> conexão associado estão em desenvolvimento e serão detalhados em documento técnico
> reservado.

> 🟡 ***P. aurea*** (bambu-dourado): colmos de 6–12 m de altura com aproveitamento
> estrutural concentrado no trecho central do colmo (diâmetro estável, sem conicidade
> extrema). Cobrem as frequências iniciais e intermediárias com folga.
> 🟢 ***P. edulis*** (bambu-mossô): colmos de maior diâmetro e comprimento, com vara
> estrutural útil superior à da *P. aurea*. Muito comum no território brasileiro; indicada
> para as frequências de maior vão.

---

### ESTRUTURA 1 — O Icosaedro Aberto V1: a Tenda de Bambu

O **icosaedro completo** é uma figura fechada. Ao remover o anel inferior de arestas, cria-se o **V1 truncagem 2/3 — a tenda autoportante**: aberta na parte de baixo para entrada, com altura generosa.

**Por que V1 é o ponto de partida ideal:**
...
>
> 🟡 ***Phyllostachys aurea* (bambu-dourado / cana-da-índia):**
> Colmo com 6–12 m de altura, mas **aproveitamento estrutural concentrado no trecho
...
A V2 é o primeiro **hemisfério verdadeiro** — base circular e plana, com área útil maior que a V1 usando varas de comprimento único e dois tipos de vara (parâmetros reservados).

---

### ESTRUTURA 3 — V3 5/8: O Domo Voador ★

O **Domo Voador** é a estrutura padrão da Plataforma Amazônia Regenerativa para habitação de interesse social, estufas de grande porte e abrigos emergenciais de alto volume. É uma **V3 truncagem 5/8** — perfil acima do equador, que maximiza o espaço interno e a altura de pé-direito central. As especificações dimensionais (contagens, coeficientes e escalas) são **reservadas para avaliação de propriedade intelectual**.
...
### A Junta Spin — conectar sem parafuso, sem precisão industrial (tecnologia LILD/PUC-Rio)

A inovação do LILD/PUC-Rio que tornou possível construir domos em comunidades sem recursos é a **junta Spin (viga recíproca)**: a ponta de cada vara se apoia sobre a vara adjacente, criando uma espiral no vértice, amarrada com corda sisal e torniquete de madeira.

**Vantagens relatadas para comunidades:**
- Custo da conexão = custo da corda (sisal ou náilon reciclado)
- Acomoda a conicidade e curvatura natural do bambu — sem a rigidez dos conectores metálicos que causam rachaduras (alegação reportada; desempenho a verificar em ensaios)
- Pode ser ensinada em 30 minutos, sem ferramentas elétricas
- Desmontável, reutilizável, transportável

> **Nota de distinção (correção material da nova edição):** esta seção descreve a Junta
> Spin do LILD/PUC-Rio. O **Sistema Takwara** (ponteira semiflexível + cabo de aço interno
> pré-tensionado com sapatilhas, selado com PU Vegetal) é tecnologia distinta, descrita
> no Documento de Conexões Estruturais da série. As duas soluções não devem ser
> confundidas. **Critério de projeto proposto (hipótese):** Junta Spin indicada até
...
> Monte um **icosaedro V1 em miniatura** com varetas de bambu de 30 cm e barbante. São poucas varetas e poucos pontos de conexão — em 20 minutos você terá na mão o modelo da tenda que pode ser escalado para qualquer tamanho. Leve para a reunião da cooperativa e mostre: *"Cada vara deste modelo, multiplicada por 10, vira uma tenda comunitária para a nossa comunidade."*
...
> 📦 **Onde vender o bambu processado — canais acessíveis a cooperativas:**
> - **CEAGESP** (São Paulo): a maior central de abastecimento da América do Sul — 3,2 milhões de toneladas/ano, 47 mil pessoas/dia, aceita cooperativas da agricultura familiar via chamadas públicas abertas. Já comercializa flores, plantas e insumos agropecuários. Link: [ceagesp.gov.br](https://ceagesp.gov.br)
> - **CEASA regionais**: CEASA-Campinas, CEASA-RJ (Rio de Janeiro), CEASA-MG (Contagem/BH), CEASA-PR (Curitiba), CEASA-SC (Florianópolis) — cada estado tem sua rede de entrepostos com vagas para cooperativas
> - **Feiras da Agricultura Familiar** (PAA/CONAB): [conab.gov.br/agricultura-familiar](https://www.conab.gov.br/agricultura-familiar)
...
1. Realize uma **reunião exploratória** — não precisa ser formal. Uma roda de conversa em uma sede de associação, salão comunitário ou debaixo de uma árvore já serve.
2. Apresente os dados básicos: quanto bambu existe na região, quanto custa manejar (ou ignorar), quanto vale o biochar, o pirolenhoso e o bambu tratado.
3. Identifique quem já maneja bambu informalmente — esses são seus primeiros cooperados.
4. Crie um **grupo de WhatsApp** e uma planilha Google Sheets compartilhada com nome, propriedade, espécie e quantidade estimada de bambu.
...
>
> 1. **WhatsApp:** envie a ficha de registro da Seção 1 desta cartilha (localização + extensão + foto) para o grupo regional da Plataforma
> 2. **iNaturalist** ([inaturalist.org](https://www.inaturalist.org)): fotografe no campo, o app georreferencia automaticamente e identifica a espécie por IA — ideal para quem não sabe o nome do bambu
> 3. **GBIF** ([gbif.org](https://www.gbif.org)): plataforma científica global — use para registros formais que alimentam bases de dados acadêmicas usadas em pedidos de licença ambiental e editais
>
...
1. Realize a **Assembleia Geral de Fundação** — lavrar ata em cartório
2. Redija o **Estatuto Social** (modelo abaixo)
3. Registre no **Cartório de Registro Civil de Pessoas Jurídicas** do município
4. Obtenha o **CNPJ** no portal da Receita Federal: [gov.br/cnpj](https://www.gov.br/receitafederal)
5. Abra conta bancária em banco cooperativo: **Sicredi** ([sicredi.com.br](https://www.sicredi.com.br)) ou **Cresol** ([cresol.com.br](https://www.cresol.com.br))
...
**Antes de qualquer edital, faça o cabo de enxada.** Não porque é o produto mais lucrativo — mas porque é a prova de conceito que convence o agricultor mais cético, o vereador mais desconfiado e o técnico do BNDES mais criterioso. **As alegações de durabilidade (5 anos) e carga (120 kg) são especificações autorais sem ensaio publicado; devem ser validadas antes de serem usadas como argumento técnico formal.**
...
**Preço de venda (estimativa autoral):** R$ 35–50 por unidade
**Margem (estimativa autoral, a validar):** 94–200%
...
| :-- | :-- | :-- |
| GCF — Green Climate Fund | Adaptação e mitigação climática | Via governo federal (MMA): [greenclimate.fund](https://www.greenclimate.fund) |
| GEF — Global Environment Facility | Biodiversidade, degradação de terra | Via PNUD Brasil: [undp.org/brazil](https://www.undp.org/pt/brazil) |
| VERRA — Mercado Voluntário de Carbono | Certificação de biochar (VM0044) | [verra.org/programs/verified-carbon-standard](https://verra.org/programs/verified-carbon-standard/) |
...
| :-- | :-- | :-- | :-- |
| Pronaf Bioeconomia | MDA / Banco do Brasil | Crédito rural para agricultores familiares | [bb.com.br/pronaf](https://www.bb.com.br/site/agro/credito/pronaf/) |
| Programa Nacional de Bambu | SFB / MAPA | Assistência técnica, pesquisa, fomento | [gov.br/agricultura/bambu](https://www.gov.br/agricultura/pt-br) |
| Inovacred (FINEP) | FINEP | Capital de risco para startups/cooperativas inovadoras | [finep.gov.br/inovacred](http://www.finep.gov.br/apoio-e-financiamento-externos/instrumentos-de-apoio/financiamentos-a-inovacao/inovacred) |
| SEBRAE — Sebraetec | SEBRAE | Consultoria técnica subsidiada para MPEs | [sebrae.com.br/sebraetec](https://sebrae.com.br/sites/PortalSebrae/sebraetec) |
| Lei 12.484/2011 (Bambu) | MAPA / SFB | Marco legal da cadeia produtiva do bambu | [planalto.gov.br](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2011/lei/l12484.htm) |
...
- Acesso ao repositório técnico: disponibilizado aos certificados após implantação (URL pública a divulgar quando disponível)
...
| **PU Vegetal** | Poliuretano derivado do óleo de mamona (insumo de fornecedor a confirmar); substitui colas e resinas petroquímicas na fabricação de compósitos |
| **Compósito BambuPU** | Material feito de fibras ou partículas de bambu misturadas com PU Vegetal; proposto como alternativa renovável a painéis convencionais — desempenho comparativo (ex.: OSB) a verificar em ensaios |
...
- Lei 5.764/71 — Cooperativismo: [planalto.gov.br/ccivil_03/leis/l5764.htm](https://www.planalto.gov.br/ccivil_03/leis/l5764.htm)
- NR-13 (Caldeiras e Vasos de Pressão): [gov.br/trabalho/NR-13](https://www.gov.br/trabalho-e-previdencia/pt-br/acesso-a-informacao/participacao-social/consultas-publicas/arquivos/nr-13-2022.pdf)

**Normas Técnicas (ABNT)**

- ABNT NBR 16828-1:2020 (Estruturas de bambu): [abnt.org.br](https://www.abnt.org.br)
- ABNT NBR 14810:2018 (Painéis de partículas): [abnt.org.br](https://www.abnt.org.br)

**Certificação de Carbono**

- VERRA VM0044 (Biochar): [verra.org/methodologies/vm0044](https://verra.org/methodologies/vm0044-methodology-for-biochar-utilization-in-soil-and-non-soil-applications/)
- Mercado de Carbono Voluntário Brasil (MCTIC): [gov.br/mcti/carbono](https://www.gov.br/mcti/pt-br)

**Ferramentas Gratuitas de Mapeamento**

- GBIF (ocorrências de espécies): [gbif.org](https://www.gbif.org)
- iNaturalist (identificação colaborativa): [inaturalist.org](https://www.inaturalist.org)
- MapBiomas (uso do solo): [mapbiomas.org](https://mapbiomas.org)
- Google Earth Engine (séries temporais de satélite): [earthengine.google.com](https://earthengine.google.com)
...
- SEBRAE Sebraetec: [sebrae.com.br/sebraetec](https://sebrae.com.br/sites/PortalSebrae/sebraetec)
- EMBRAPA Bambu: [embrapa.br](https://www.embrapa.br/busca-de-publicacoes/-/publicacao/1154259/estimativa-de-volume-de-bambu-guadua-spp-do-acre-amazonia-brasil)
- Serviço Florestal Brasileiro: [florestal.gov.br](https://www.florestal.gov.br)
- OCB (Organização das Cooperativas Brasileiras): [ocb.org.br](https://www.ocb.org.br)
...
## 13. CHANGELOG — VERSÃO CANDIDATA 2.2 (nova edição)
...
## 14. DECLARAÇÃO DE LIMITES (nova edição)

1. Esta cartilha é um **guia prático e autoral**; valores de mercado, custos, margens e
   prazos citados são estimativas autorais a validar (ex.: R$ 180 milhões/ano na RMC;
   custos de cartório; limites BNDES/FAPESP; crédito de carbono ~R$ 80–120/tCO₂e).
2. Alegações de desempenho do cabo de enxada (durabilidade 5 anos; carga >120 kg) são
   **especificações autorais sem ensaio publicado** — desempenho a verificar antes de uso
   comercial como argumento técnico.
3. A Junta Spin é tecnologia do **LILD/PUC-Rio** (Ripper); o Sistema Takwara (ponteira/
   cabo semiflexível) é tecnologia distinta. O critério "Junta Spin até V2; Takwara V3+"
   é **hipótese/critério de projeto proposto, sem fonte técnica explícita** — não fato
   validado.
4. Exemplos comunitários são **relatos ilustrativos não verificados** (decisão D-B):
   sem consentimento/proveniência documental, não têm valor de testemunho documental ou
   evidência validada; nomes próprios preservados apenas para fins pedagógicos.
5. **Parâmetros construtivos reservados (decisão D-C):** contagens de varas, tipos,
   conectores, coeficientes de truncagem e escalas de dimensionamento das estruturas
   geodésicas (incluindo as derivadas de especificações técnicas de terceiros) e a
   bitola do fio de aço foram removidos desta versão pública e são **reservados para
   avaliação de propriedade intelectual**, constando apenas em documento técnico
   reservado.
6. Nenhuma declaração de TRL é feita; a maturidade das tecnologias deve ser declarada em
   documento próprio com base em evidência.
7. O endpoint github.com/amazonia-regenerativa foi **removido desta versão** — URL
   inexistente (HTTP 404 em 2026-08-09); a referência ao repositório técnico foi
   substituída por menção genérica ("disponibilizado aos certificados após implantação").
8. A marca MAMONEX RD70 (Imperveg) foi **removida desta versão** por ausência de
   autorização de citação pública; o PU Vegetal é citado apenas como insumo de
   fornecedor a confirmar na etapa de fechamento.
